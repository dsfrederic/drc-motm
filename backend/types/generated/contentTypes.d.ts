...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    votingStart: Attribute.DateTime;
    votingEnd: Attribute.DateTime;
    homeTeam: Attribute.Relation<
      'api::game.game',
      'oneToOne',
      'api::team.team'
    >;
...
export interface ApiVoteVote extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    game: Attribute.Relation<'api::vote.vote', 'oneToOne', 'api::game.game'>;
    manOfTheMatch: Attribute.Relation<
      'api::vote.vote',
      'oneToOne',
      'api::player.player'
    >;
    runnerUp: Attribute.Relation<
      'api::vote.vote',
      'oneToOne',
      'api::player.player'
    >;
